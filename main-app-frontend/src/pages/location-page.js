...
export default function Location() {
    ...
    try {
      ...
      const markers = imageJson.map(image => ({
        ...
        popUp: (
          <div>
            <img
              src={`http://localhost:4000${image.thumbnailUrl}`}
              alt={image.fileName}
  ...
  return (
    <div className="app-container" style={{background:'#f0ece3'}}>
      <div className="date-picker-container" style={{ display: "block !important", zIndex: "99", height: "30px" }}>
        <DatePicker
          selected={startDate}
